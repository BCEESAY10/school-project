    ...
    <div className="bg-white px-10 py-20 rounded-3xl border-gray-200">
      ...
      <div className="mt-8">
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          ...
          <button className="flex py-3 border-2 border-gray-200 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl items-center justify-center gap-2">
